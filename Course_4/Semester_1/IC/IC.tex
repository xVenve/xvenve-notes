	...
	\item \textbf{Motor de Inferencia (MI):} Razona sobre el conocimiento del problema y sobre su solución. Determina como se aplican las reglas.
	      ...
	      \begin{itemize}
		      \item \textbf{Fase de selección}
		            ...
		            \pagebreak
		      \item \textbf{Fase de acción o ejecución}: La ejecución de una instancia de una regla modifica la Base de Hechos actual dando lugar a una Base de Hechos nueva al añadir, borrar y/o modificar. La nueva BH es el punto de partida para el siguiente ciclo.
...
\begin{description}
	...
	\item[(retract indice-hecho)] Eliminar hechos de la base de hechos.
...
\begin{itemize}
	\item Un patrón que se encarga de consultar la existencia de un hecho en la Memoria de e trabajo.
...
\begin{itemize}
	...
	\item \textbf{eq:} TRUE si los argumentos son iguales en valor y tipo, sino FALSE.
	\item \textbf{neq:} TRUE si alguno de los valores de las expresiones argumento es distinto, sino FALSE.
