...
Poco después Artrópodos y otros animales.
...
-6 Ma Homínidos. Algo peculiar de los humanos y simios es que son consciente de su propia existencia, a diferencia de otros animales.
...
\subsection{El Ácido Desoxirribonucleico}
...
Hay 4$^3$ = 64 posibles codones para 20 aminoácidos.

Algunos no codifican aminoácidos, sino controles (STOP).

Más de un codón codifica un mismo aminoácido.

Código autocorrector.- Los aminoácidos más numerosos son codificados por más codones, y parecidos. Esto evita las mutaciones destructivas.
...
\subsection{Tipos de reproducción}
Tienen un solo juego de cromosomas. Los individuos se reproducen por sí mismos. La reproducción da lugar a individuos genéticamente idénticos al progenitor

Los cromosomas están pareados. Las células sexuales se generan mediante meiosis y son “haploides”, conteniendo información redundante e incluso contradictoria. Los descendientes reciben un cromosoma de cada uno de los progenitores para formar un embrión diploide

\subsection{Haplo-Diploidad}
