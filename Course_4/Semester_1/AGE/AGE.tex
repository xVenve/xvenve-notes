...
El procedimiento es análogo a cualquier sistema evolutivo:
\begin{enumerate}
	\item Generar un \textbf{conjunto de individuos} aleatoriamente (población inicial) 
	\item \textbf{Seleccionar} un conjunto de individuos a reproducir (mating pool) 
	\item Aplicar \textbf{operadores genéticos} al “mating pool” para obtener una nueva población (t + 1) 
	\item \textbf{Repetir} el proceso hasta alcanzar algún criterio de convergencia (parada)
\end{enumerate}
Los operadores genéticos son un operador de \textbf{cruce y tres de mutación}
\vspace{-.5cm}
