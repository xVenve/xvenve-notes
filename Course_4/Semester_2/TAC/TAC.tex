...
Coste de los procesos computacionales

Complejidad de los algoritmos: Recursivos y No recursivos.

Veremos como cuantificar el coste con órdenes de complejidad.

\chapter{Teoría de la Computabilidad}\label{ch:teoría-de-la-computabilidad}
Clasificar los distintos problemas y formalizar el concepto de computar.

Ver el papel que juegan las Máquinas de Turing en la clasificación de problemas: Decibilidad y No decidibilidad.
