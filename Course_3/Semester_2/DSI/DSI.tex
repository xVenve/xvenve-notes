...
fáciles de percibir y Gaver(90s) perceptiblFalsas ocultas.
...
\begin{description}
  ...
  \item[Personalidad] Predisposiciones y patrones de actitud, pensamiento, sentimientos, y comportamiento. Mas persistente y estable.
\end{description}
...
\textbf{Criticas:} Validez y rigor metodológico (el tipo de estudio antropológicos), replicabilidad...
...
Mas allá de una serie de parámetros y propiedades. Altamente subjetivas, embodied.
...
\begin{itemize}
  ...
  \item De teoría del aprendizaje: comportamiento – reduce tensiones con éxito – repetición à aprendizaje
...
Basado en el trabajo de BJ Fogg: Triada funcional y principios de diseño.
...
El circulo mágico del juego, es uno de los conceptos más extendidos.
...
\begin{itemize}
  ...
  \end{itemize}
  \item Antes de que sea tarde, como en producción o postventa, que encarece arreglar los problemas que podamos tener.
  \item Para comprobar que vamos en el buen camino y que el producto cumple con los objetivos.
  \item También por que buscamos producir un producto bien diseñado
  \begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{RE-DISEÑAR:} Descubrir nuevo requisitos y necesidades, iterar el diseño.
\end{itemize}
...
\begin{itemize}
  ...
  \textbf{Critica}: Precisión, exactitud, hay sesgo del investigador o inexperiencia de investigador.
...
Que heurísticas y cuantos elementos, depende del objetivo, pero entre 5 y 10 elementos. Cuantos investigadores, entre 3 y 5 dependiendo de la experiencia de estos.
  ...
  Tres fases:
  \begin{itemize}
    \item \textbf{Sesión informativa}, se informa a los investigadores del objetivo de evaluación a través de un guion. Se les da un escenario y tareas par aun usuario objetivo.
...
Objetivo: Para conseguir de primera mano apreciacion de las condiciones exitentes o futuras.
...
Buscan una participación activa, embodied de los participantes. Usan emdied design methods. Vivir en primera persona los touchpoints claves con la tecnologia, el flujo de la interacción entre touchpoints.
...
\textbf{HomeLab}
\begin{itemize}
  \item Se trata de espacio controlados muy similares a los contextos, en lo que se toman multitud de tipos de datos.
...
\begin{itemize}
  ...
  \item Modelos y evaluaciones predictivas: Mas rápidas, pero se le escapan muchos aspectos.
