...
El objetivo de las prácticas no es pegar los resultados o con captura,
si no documentar bien, incluyendo tablas y gráficas.
...
values) u outliers (que se salen de sus valores)
...
\begin{itemize}
  \item Más especifico a más general, como GOLEM.
