...
\textbf{Clustering jerárquico:} No sol se generan grupos, sino también una jerarquía entre ellos.

\textbf{Búsqueda hacia arriba:} 
\begin{enumerate}
  \item Inicialmente, cada representa un ejemplo.
...
Se tienen dos conjuntos de datos independientes con diferentes atributos, que entrenan clasificadores independientes, y etiquetar las demás instancias con la clase que diga el clasificador que tenga más confianza y repetir el proceso.

\subsection{CO-EM}

Entrenas con las clasificadas y los resultados pasan al conjunto de entrenamiento.

Aprendizaje supervisado con las instancias etiquetadas. Realiza en bucle, clasificar las instancias no etiquetadas y reconstruir el clasificador.
