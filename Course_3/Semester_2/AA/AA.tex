...
\section{Medidas adicionales del rendimiento}
...
\cline{3-4}
                                                                                                  &                                                         & \multicolumn{2}{c|}{\cellcolor[HTML]{34CDF9}{\color[HTML]{FFFFFF} Clase real}}                                                        \\ \cline{3-4} 
                                                                                                  &                                                         & \cellcolor[HTML]{32CB00}{\color[HTML]{FFFFFF} Positiva}           & \cellcolor[HTML]{FE0000}{\color[HTML]{FFFFFF} Negativa}           \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{34CDF9}{\color[HTML]{FFFFFF} }}                             & \cellcolor[HTML]{32CB00}{\color[HTML]{FFFFFF} Positiva} & \begin{tabular}[c]{@{}c@{}}Positivo\\ Verdadero (TP)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Falso\\ Positivo (FP)\end{tabular}     \\ \cline{2-4} 
\multicolumn{1}{|c|}{\multirow{-2}{*}{\cellcolor[HTML]{34CDF9}{\color[HTML]{FFFFFF} Predicción}}} & \cellcolor[HTML]{FE0000}{\color[HTML]{FFFFFF} Negativa} & \begin{tabular}[c]{@{}c@{}}Falso\\ Negativo (FN)\end{tabular}     & \begin{tabular}[c]{@{}c@{}}Negativo\\ Verdadero (TN)\end{tabular} \\ \cline{1-1} \cline{3-4} 
\end{tabular}
...
%Straight Lines [id:da48912769607859996] 
\draw    (420,20) -- (150,290) ;
%Straight Lines [id:da07809475437797575] 
\draw    (160,20) -- (160,280) ;
%Straight Lines [id:da7666140860911692] 
\draw    (160,280) -- (420,280) ;
%Straight Lines [id:da2427096733098011] 
\draw    (150,40) -- (400,40) ;
%Straight Lines [id:da6726693666957959] 
\draw    (400,40) -- (400,290) ;

% Text Node
\draw (13,15) node [anchor=north west][inner sep=0.75pt]   [align=left] {ratio de positivos\\verdaderos = recall};
% Text Node
\draw (439,262) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{66.23pt}\setlength\topsep{0pt}
\begin{center}
...
\end{minipage}};
% Text Node
\draw (381,291) node [anchor=north west][inner sep=0.75pt]   [align=left] {1};
% Text Node
\draw (171,12) node [anchor=north west][inner sep=0.75pt]   [align=left] {1};
% Text Node
\draw (201,102) node [anchor=north west][inner sep=0.75pt]   [align=left] {Razonable};
		      ...
		      \item \textbf{Reducción de datos:} Reducir la variedad.
		            ...
		            \begin{itemize}
			            ...
			            \item \textbf{Selección de atributos:}
			                  ...
			                  \begin{itemize}
				                  \item Reducción de la dimensionalidad de los datos, mediante filtrado según algún criterio o seleccionando un subconjunto.
				                  \item \textbf{Búsqueda}: Cualquier técnica.
				                  \item \textbf{Evaluación}: Correlación, entropía, etc.
				                  \item \textbf{Criterio de parada:} Porcentaje, umbral, iteraciones, etc.
				                  \item \textbf{Técnicas de wrapper}: Se genera el modelo con todos los atributos, se evalúa el modelo y se ve el subconjunto de atributos mejores.
				                  \item \textbf{Búsqueda en el espacio de estado de los conjuntos de
					                        atributos.}
				                        \begin{itemize}
					                        \item Se puede comenzar por el conjunto completo (por arriba) o por el conjunto vacío (por abajo).
					                        \item La búsqueda puede ser de cualquier tipo.
					                        \item La evaluación de cada nodo, que son subconjuntos de atributos, se realiza llamando al algoritmo inductivo seleccionado, una función de evaluación. Tras evaluar se opera.
				                        \end{itemize}
				                  \item \textbf{PCA (No lo usaremos):} Análisis de componentes principales. Es una solución algebraica, describe los datos en términos de nuevos atributos que no están correlados entre sí.
			                  \end{itemize}
			            \item \textbf{Datos no balanceados:} Crear ejemplos sintéticos de la clase desbalanceada.
		            \end{itemize}
	      \end{itemize}
	\item \textbf{Diseño}: Selección de algoritmo y Selección de parámetros.
	\item \textbf{Ejecución de algoritmo.}
	\item \textbf{Postproceso.}
...
\subsection{Hipótesis más probable (MAP)}
...
%Straight Lines [id:da5244047550527262] 
\draw    (298,150) -- (353,150.11) ;
\draw [shift={(355,150.11)}, rotate = 180.11] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Ellipse [id:dp005350822023084234] 
\draw   (250,150) .. controls (250,122.39) and (283.58,100) .. (325,100) .. controls (366.42,100) and (400,122.39) .. (400,150) .. controls (400,177.61) and (366.42,200) .. (325,200) .. controls (283.58,200) and (250,177.61) .. (250,150) -- cycle ;
%Straight Lines [id:da2428669600286424] 
\draw    (372,150) -- (440,150) ;
\draw [shift={(442,150)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da2108327199440594] 
\draw    (230,90) -- (278.44,128.75) ;
\draw [shift={(280,130)}, rotate = 218.66] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da5437083844551118] 
\draw    (110,150) -- (268,150) ;
\draw [shift={(270,150)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da06004854365587553] 
\draw    (110,200) -- (268.09,150.6) ;
\draw [shift={(270,150)}, rotate = 522.65] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da3199592630984822] 
\draw    (110,100) -- (268.09,149.4) ;
\draw [shift={(270,150)}, rotate = 197.35] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;


% Text Node
\draw (71,52) node [anchor=north west][inner sep=0.75pt]   [align=left] {entradas};
% Text Node
\draw (151,52) node [anchor=north west][inner sep=0.75pt]   [align=left] {pesos};
% Text Node
\draw (211,52) node [anchor=north west][inner sep=0.75pt]   [align=left] {umbral};
% Text Node
\draw (323,42) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{53.19pt}\setlength\topsep{0pt}
\begin{center}
...
\end{minipage}};
% Text Node
\draw (418,111) node [anchor=north west][inner sep=0.75pt]   [align=left] {salida};
% Text Node
\draw (448,141) node [anchor=north west][inner sep=0.75pt]   [align=left] {s};
% Text Node
\draw (216,72) node [anchor=north west][inner sep=0.75pt]   [align=left] {U};
% Text Node
\draw (91,92) node [anchor=north west][inner sep=0.75pt]   [align=left] {x1};
% Text Node
\draw (91,141) node [anchor=north west][inner sep=0.75pt]   [align=left] {x2};
% Text Node
\draw (91,191) node [anchor=north west][inner sep=0.75pt]   [align=left] {xn};
% Text Node
\draw (158,92) node [anchor=north west][inner sep=0.75pt]   [align=left] {w1};
% Text Node
\draw (158,132) node [anchor=north west][inner sep=0.75pt]   [align=left] {w2};
% Text Node
\draw (161,192) node [anchor=north west][inner sep=0.75pt]   [align=left] {wn};
% Text Node
\draw    (354,138) -- (372,138) -- (372,162) -- (354,162) -- cycle  ;
\draw (357,142.4) node [anchor=north west][inner sep=0.75pt]    {$f$};
% Text Node
\draw (309.5,131) node [anchor=north west][inner sep=0.75pt]   [align=left] {RED};
% Text Node
\draw    (278,138) -- (298,138) -- (298,162) -- (278,162) -- cycle  ;
\draw (281,142.4) node [anchor=north west][inner sep=0.75pt]    {$\Sigma $};


\end{tikzpicture}}
\end{figure}
Las \textbf{entradas son los valores de los atributos} (\(x_1,x_2,..,x_n\)) y un umbral, se hace \textbf{combinación lineal de las entradas con unos pesos} (\(w_0+w_1x_1+...+w_nx_n\)) y se pasa el \textbf{resultado por una función de activación} que nos da la salida.
