...
importante definir el \enquote{delimitador}.

\begin{itemize}
	\item Carácter que \textbf{delimita el token sin pertenecer} a él.
\end{itemize}

Otro concepto importante es el de \enquote{\textbf{palabra reservada}}
...
\begin{multicols}{2}
	\begin{table}[H]
		\centering
		\begin{tabular}{c|l|c}
			\textbf{Mensaje} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Elementos\\ Información\end{tabular}}} & \textbf{Obl.}                  \\ \hline
	...
	\begin{table}[H]
		\centering
		\begin{tabular}{l|c|c}
			                      & \textbf{Campo 1} & \textbf{Campo 2}               \\ \hline
			\textbf{EIsetup}      & ''A''            & [A-Z, a-z, 0-9]                \\ \hline
			\textbf{EIsetupACK}   & ''B''            & [A-Z, a-z, 0-9]                \\ \hline
			\textbf{EIconnect}    & ''C''            & [A-Z, a-z, 0-9]                \\ \hline
			\textbf{EIconnectACK} & ''D''            & [A-Z, a-z, 0-9]                \\ \hline
			\textbf{EIsentido}    & ''E''            & \begin{tabular}[c]{@{}c@{}}0 $A \rightarrow B$\\ 1 $B \rightarrow A$\end{tabular} \\ \hline
			\textbf{EIorigen}     & ''F''            & [0-9]$^3$                      \\ \hline
			\textbf{EIdestino}    & ''G''            & [0-9]$^3$                      \\ \hline
		\end{tabular}
	\end{table}
...
\begin{enumerate}
	...
	\item Calcular Conjuntos Siguientes.
	      ...
	      \end{multicols}
	      \pagebreak
	\item Calcular Conjuntos de Predicción.
	...
	\item Comprobación de las Condiciones de LL(1)
	      ...
	      $$\left. PP
		      ...
		      \end{matrix}
	      $$
	\item Tabla de Conjuntos de Predicción
...
\begin{figure}[H]
	\ffigbox[\FBwidth]
	{\caption{Tablas para registros}}
	{\def\svgwidth{.9\textwidth}
		\input{./img/tiposAtributos.eps_tex}}
\end{figure}
...
\begin{figure}[H]
	\ffigbox[\FBwidth]
	{\caption{Recorridos grados de dependencias}}
	{\centering
		\def\svgwidth{1.1\textwidth}
		\input{./img/Recorrido.pdf_tex}}
\end{figure}
...
\begin{figure}[H]
	...
	{\caption{Tablas para registros}}
	{\def\svgwidth{.9\textwidth}
		\input{./img/tablaRegistro.eps_tex}}
\end{figure}
...
\href{https://drive.google.com/file/d/1Goyza5nuDCrGsduROwLEsG9dttk4SXsC}{Acceso en Drive a las diapositivas}
\end{document}