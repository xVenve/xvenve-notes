...
\begin{itemize}
	...
	\begin{table}[H]
		...
		& \begin{tabular}[c]{@{}c@{}}Orientado a la funcionalidad\\ -\textgreater Hacer Transacciones\end{tabular} & \begin{tabular}[c]{@{}c@{}}Orientado a datos - \\ Acceder a los datos de un recurso\end{tabular} \\ \hline
