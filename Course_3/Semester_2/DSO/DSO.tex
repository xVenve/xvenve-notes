...
El problema de usar TCP y HTTP (basado en TCP) es que son muy ricos en información que es una ventaja, pero en el caso de los dispositivos IoT no es posible disponer de recursos están limitados, por lo que se preferirá aquellos más ligeros.
...
\begin{figure}[H]
	...
	{\includegraphics[scale=.4]{2021-04-08 09_17_44-2021-04-07 17-01-12.mkv.png}
...
A diferencia de HTTP, no es necesario que el publicador sepa a quien enviárselo, de esta manera se reduce también el consumo de recursos. Al igual los suscriptores no tienen que consultar a d montón de publicadores, solo al broker.

\newpage

\section{Servicio RESTful}

Es la alternativa a los protocolos basados en mensajes.
...
\begin{figure}[H]
	...
	{\includegraphics[scale=.5]{2021-04-08 09_36_12-2021-04-07 17-01-12.mkv.png}}
\end{figure}
...
Se debe tener encuentra cuál es el tamaño máximo de los mensajes según el proveedor (IBM Watson allows for payload sizes up to 128 KB, while Google supports 256 KB), dado que admite cualquier archivo hay que cuidar de esto
