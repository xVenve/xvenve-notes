...
Es un servicio que está disponible en la plataforma IoT y como su nombre indica (miceo) proporciona una capacidad especifica que necesitamos y es accesible mediante una API.
...
Aquellas que se implementan como un gran cuerpo con todo el código y se necesita utilizar el sistema. n
...
Como se tienen distintas interfaces que tienen distintos componentes de interfaz visual, de manera que se utiliza un orquestado distinto para los distintos tipos de interfaces de usuario (web/mobile), se gestionan los microservicios de manera distinta para que se adapten mejor a estas.
...
Se gestiona un backends para cada interfaz cada cuenta con su orquestador/coreografiador.
...
\begin{itemize}
	...
	Hay muchas posibles interfaces lo que hace que se vuelva más complejo, al haber tanta variedad de dispositivos, necesidades que cubrir y requisitos que satisfacer.
\end{itemize}	
