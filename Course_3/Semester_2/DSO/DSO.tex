...
\begin{itemize}
	\item \textbf{Middleware básico - core:} Relacionado con la gestión de las comunicaciones (Controladores de Red) y elementos que permitan virtualizar el funcionamiento.
...
\section{Tema 2: Sensores yActuadores}
