...
\item
  ...
  facilitar compras.
\item
  \textbf{Ciudad}: Recoge muchas áreas; basura, vigilancia, tráfico,
  etc.
\item
...
\item
  ...
  barato.
\item
  \textbf{Sistema crítico}, aquel del que el tiempo de respuesta es
...
\textbf{¿Cuál es el usuario por defecto con el que te logueas en una nueva máquina virtual en GCP?}
\begin{itemize}
