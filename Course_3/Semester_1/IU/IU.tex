...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
		...
		%Rounded Rect [id:dp7418316774400673] 
		\draw   (210.5,156) .. controls (210.5,152.69) and (213.19,150) .. (216.5,150) -- (284.5,150) .. controls (287.81,150) and (290.5,152.69) .. (290.5,156) -- (290.5,174) .. controls (290.5,177.31) and (287.81,180) .. (284.5,180) -- (216.5,180) .. controls (213.19,180) and (210.5,177.31) .. (210.5,174) -- cycle ;

		%Rounded Rect [id:dp011460275473892612] 
		\draw   (40,83.71) .. controls (40,79.3) and (43.58,75.71) .. (48,75.71) -- (102,75.71) .. controls (106.42,75.71) and (110,79.3) .. (110,83.71) -- (110,107.71) .. controls (110,112.13) and (106.42,115.71) .. (102,115.71) -- (48,115.71) .. controls (43.58,115.71) and (40,112.13) .. (40,107.71) -- cycle ;

		%Rounded Rect [id:dp34259105463463624] 
		\draw   (161.76,86.71) .. controls (161.76,83.4) and (164.45,80.71) .. (167.76,80.71) -- (224.24,80.71) .. controls (227.55,80.71) and (230.24,83.4) .. (230.24,86.71) -- (230.24,104.71) .. controls (230.24,108.03) and (227.55,110.71) .. (224.24,110.71) -- (167.76,110.71) .. controls (164.45,110.71) and (161.76,108.03) .. (161.76,104.71) -- cycle ;

		%Rounded Rect [id:dp9997649137317774] 
		\draw   (280,86) .. controls (280,82.69) and (282.69,80) .. (286,80) -- (334,80) .. controls (337.31,80) and (340,82.69) .. (340,86) -- (340,104) .. controls (340,107.31) and (337.31,110) .. (334,110) -- (286,110) .. controls (282.69,110) and (280,107.31) .. (280,104) -- cycle ;

		%Rounded Rect [id:dp5693611116735091] 
		\draw   (390.27,80.29) .. controls (390.27,74.61) and (394.88,70) .. (400.56,70) -- (465.44,70) .. controls (471.12,70) and (475.73,74.61) .. (475.73,80.29) -- (475.73,111.14) .. controls (475.73,116.82) and (471.12,121.43) .. (465.44,121.43) -- (400.56,121.43) .. controls (394.88,121.43) and (390.27,116.82) .. (390.27,111.14) -- cycle ;

		%Straight Lines [id:da8762068159537153] 
		\draw    (110,100) -- (158,100) ;
		\draw [shift={(160,100)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Straight Lines [id:da9072118339705906] 
		\draw    (230,100) -- (278,100) ;
		...
		%Straight Lines [id:da9412280915661362] 
		\draw    (340,100) -- (388,100) ;
		...
		%Curve Lines [id:da8394500190450778] 
		\draw    (330,110) .. controls (335.88,127.8) and (323.83,160.81) .. (291.98,160.09) ;
		\draw [shift={(290,160)}, rotate = 363.72] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Curve Lines [id:da68792340420299] 
		\draw    (210,160) .. controls (182.56,162.12) and (180.09,141.36) .. (180,111.82) ;
		...
		% Text Node
		\draw (395.5,76.71) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{52.64pt}\setlength\topsep{0pt}
				\begin{center}
			...
			\end{minipage}};
		% Text Node
		\draw (47,76.71) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{39.57pt}\setlength\topsep{0pt}
				\begin{center}
					What is \\wanted
				\end{center}
			...
			\end{minipage}};
		% Text Node
		\draw (167,87.21) node [anchor=north west][inner sep=0.75pt]   [align=left] {Analysis};
		% Text Node
		\draw (217.5,156.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {Prototype};
		% Text Node
		\draw (285.5,86.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {Design};
		% Text Node
		\draw (31,30) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{66.68pt}\setlength\topsep{0pt}
				\begin{center}
					{\scriptsize Conocer usuarios}\\{\scriptsize y requisitos}
				\end{center}

			\end{minipage}};
		% Text Node
		\draw (161,32) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{50.34pt}\setlength\topsep{0pt}
				\begin{center}
					{\scriptsize Analizamos }\\{\scriptsize los requisitos}
				\end{center}

			\end{minipage}};
		% Text Node
		\draw (391,30) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{57.15pt}\setlength\topsep{0pt}
				\begin{center}
					{\scriptsize Crear producto}\\{\scriptsize y lanzarlo}
				\end{center}

			\end{minipage}};
		% Text Node
		\draw (181,180) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{91.17pt}\setlength\topsep{0pt}
				\begin{center}
					{\footnotesize Crear prototipo para}\\{\footnotesize captar nuevos requisitos}
				\end{center}
...
\begin{itemize}
	...
	\item Mantener la consistencia

	      \begin{itemize}
		      \item Debe hacerse un uso semántico del color y de otros recursos
		            audiovisuales.
...
\begin{itemize}
	\item Heurísticas de Schneiderman: No hace falta sabérselas.
	\item Heurísticas de Nielsen y Molich: No hace falta sabérselas.

	      \pagebreak
	\item Heurísticas de Nielsen: Es en las que nos centraremos.

	      \begin{itemize}
		      \item Visibilidad del estado del sistema: Barras de progreso o
		            animaciones de carga.

		      \item Coincidencia entre el sistema y el mundo real: Relación de los
		            elementos web con lo que conoce el usuario.

		      \item Control del usuario y libertad: El usuario puede confirmar,
		            cancelar o cambiar el estado del sistema.

		      \item Consistencia y estandarización: Para que el usuario lo
		            entienda al conocer lo estándar y que la información se
		            muestre siempre de la misma manera.

		      \item Prevención de errores: Poner las cosas claras y diferenciadas
		            para evitar errores. Sugerencias.

		      \item Reconocimiento antes que recuerdo: Mostrarlo visualmente en
		            vez de hacer que recuerde su nombre, o parcialmente con auto
		            rellenado.

		      \item Flexibilidad y eficiencia de uso: Permite hacer variaciones y
		            usar comandos o métodos más rápidos de uso.

		      \item Estética y diseño minimalista: Que no esté abarrotado y se
		      ...
		      \item Ayuda y documentación: Sección de ayuda para que el usuario
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
		...
		%Rounded Rect [id:dp5785365799224729] 
		\draw   (22.63,28.9) .. controls (22.63,23.98) and (26.62,20) .. (31.53,20) -- (112.6,20) .. controls (117.52,20) and (121.5,23.98) .. (121.5,28.9) -- (121.5,55.59) .. controls (121.5,60.51) and (117.52,64.49) .. (112.6,64.49) -- (31.53,64.49) .. controls (26.62,64.49) and (22.63,60.51) .. (22.63,55.59) -- cycle ;

		%Rounded Rect [id:dp5510092157707689] 
		\draw   (192.01,33.46) .. controls (192.01,30.22) and (194.63,27.6) .. (197.87,27.6) -- (244.39,27.6) .. controls (247.63,27.6) and (250.25,30.22) .. (250.25,33.46) -- (250.25,51.03) .. controls (250.25,54.27) and (247.63,56.89) .. (244.39,56.89) -- (197.87,56.89) .. controls (194.63,56.89) and (192.01,54.27) .. (192.01,51.03) -- cycle ;

		%Rounded Rect [id:dp6583967689823766] 
		\draw   (320.76,33.24) .. controls (320.76,29.93) and (323.45,27.24) .. (326.76,27.24) -- (364.76,27.24) .. controls (368.07,27.24) and (370.76,29.93) .. (370.76,33.24) -- (370.76,51.24) .. controls (370.76,54.56) and (368.07,57.24) .. (364.76,57.24) -- (326.76,57.24) .. controls (323.45,57.24) and (320.76,54.56) .. (320.76,51.24) -- cycle ;

		%Rounded Rect [id:dp22083378561995315] 
		\draw   (441.27,33.24) .. controls (441.27,29.93) and (443.96,27.24) .. (447.27,27.24) -- (475,27.24) .. controls (478.31,27.24) and (481,29.93) .. (481,33.24) -- (481,51.24) .. controls (481,54.56) and (478.31,57.24) .. (475,57.24) -- (447.27,57.24) .. controls (443.96,57.24) and (441.27,54.56) .. (441.27,51.24) -- cycle ;

		%Straight Lines [id:da20703442622671564] 
		\draw    (121.5,47.24) -- (189.5,47.24) ;
		\draw [shift={(191.5,47.24)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Straight Lines [id:da7094899392835952] 
		\draw    (191.5,37.24) -- (123.5,37.24) ;
		\draw [shift={(121.5,37.24)}, rotate = 360] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

		%Rounded Rect [id:dp43957149790531846] 
		\draw   (551.5,33.24) .. controls (551.5,29.93) and (554.19,27.24) .. (557.5,27.24) -- (644,27.24) .. controls (647.31,27.24) and (650,29.93) .. (650,33.24) -- (650,51.24) .. controls (650,54.56) and (647.31,57.24) .. (644,57.24) -- (557.5,57.24) .. controls (554.19,57.24) and (551.5,54.56) .. (551.5,51.24) -- cycle ;

		%Straight Lines [id:da2572357726948422] 
		\draw    (251.5,47.24) -- (319.5,47.24) ;
		\draw [shift={(321.5,47.24)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Straight Lines [id:da6545976015128743] 
		\draw    (321.5,37.24) -- (253.5,37.24) ;
		\draw [shift={(251.5,37.24)}, rotate = 360] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

		%Straight Lines [id:da9603530185883957] 
		\draw    (371.5,47.24) -- (439.5,47.24) ;
		\draw [shift={(441.5,47.24)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Straight Lines [id:da3227388858627891] 
		\draw    (441.5,37.24) -- (373.5,37.24) ;
		\draw [shift={(371.5,37.24)}, rotate = 360] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

		%Straight Lines [id:da3516528975968767] 
		\draw    (481.5,47.24) -- (549.5,47.24) ;
		\draw [shift={(551.5,47.24)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Straight Lines [id:da691950308061211] 
		\draw    (551.5,37.24) -- (483.5,37.24) ;
		\draw [shift={(481.5,37.24)}, rotate = 360] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;


		% Text Node
		\draw (24.57,23.24) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{66.23pt}\setlength\topsep{0pt}
				\begin{center}
			...
			\end{minipage}};
		% Text Node
		\draw (196.63,33.74) node [anchor=north west][inner sep=0.75pt]   [align=left] {Design};
		% Text Node
		\draw (326.76,33.74) node [anchor=north west][inner sep=0.75pt]   [align=left] {Code};
		% Text Node
		\draw (446.13,33.74) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{21.43pt}\setlength\topsep{0pt}
				\begin{center}
					Test
				\end{center}
			...
			\end{minipage}};
		% Text Node
		\draw (556.75,33.74) node [anchor=north west][inner sep=0.75pt]   [align=left] {Maintenance};
