...
\begin{figure}[H]
	...
	{\def\svgwidth{.8\textwidth}
		\input{./img/Systems_Engineering_Process_II.pdf_tex}}
\end{figure}
...
\begin{itemize}
	\item Historias de usuario: Manera cómoda de obtener especificaciones de
	      los usuarios. Lo escriben ellos mismos.
	      \begin{itemize}
		      \item Como \_\_\_ quiero \_\_\_\_ para \_\_\_\_
	      \end{itemize}
	\item Prototipos: Permite extraer requisitos, ensayar soluciones y
	      ...
	      \end{itemize}
	\item Diagramas de Casos de uso: Muestran las funciones y la relación
	      ...
	      \begin{figure}[H]
		      ...
		      \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
			      ...
			      %Shape: Circle [id:dp12209901519789801] 
			      \draw   (175.5,65.5) .. controls (175.5,60.25) and (179.75,56) .. (185,56) .. controls (190.25,56) and (194.5,60.25) .. (194.5,65.5) .. controls (194.5,70.75) and (190.25,75) .. (185,75) .. controls (179.75,75) and (175.5,70.75) .. (175.5,65.5) -- cycle ;
			      %Straight Lines [id:da3368209994354574] 
			      \draw    (185.5,105) -- (195.5,115) ;
			      %Straight Lines [id:da12168900220263712] 
			      \draw    (185.5,75) -- (185.5,105) ;
			      %Straight Lines [id:da752450411088543] 
			      \draw    (175.5,115) -- (185.5,105) ;
			      %Straight Lines [id:da33569795380702305] 
			      \draw    (185.5,85) -- (195.5,95) ;
			      %Straight Lines [id:da18314501442733744] 
			      \draw    (175.5,95) -- (185.5,85) ;

			      %Shape: Circle [id:dp9804408266392555] 
			      \draw   (352,100) .. controls (352,94.75) and (356.25,90.5) .. (361.5,90.5) .. controls (366.75,90.5) and (371,94.75) .. (371,100) .. controls (371,105.25) and (366.75,109.5) .. (361.5,109.5) .. controls (356.25,109.5) and (352,105.25) .. (352,100) -- cycle ;
			      %Straight Lines [id:da8578715405115578] 
			      \draw    (362,139.5) -- (372,149.5) ;
			      %Straight Lines [id:da16324580119039345] 
			      \draw    (362,109.5) -- (362,139.5) ;
			      %Straight Lines [id:da3222809586850013] 
			      \draw    (352,149.5) -- (362,139.5) ;
			      %Straight Lines [id:da5644701625176025] 
			      \draw    (362,119.5) -- (372,129.5) ;
			      %Straight Lines [id:da8331685776523305] 
			      \draw    (352,129.5) -- (362,119.5) ;

			      %Shape: Circle [id:dp9312974890610017] 
			      \draw   (352,31) .. controls (352,25.75) and (356.25,21.5) .. (361.5,21.5) .. controls (366.75,21.5) and (371,25.75) .. (371,31) .. controls (371,36.25) and (366.75,40.5) .. (361.5,40.5) .. controls (356.25,40.5) and (352,36.25) .. (352,31) -- cycle ;
			      %Straight Lines [id:da983028263184665] 
			      \draw    (362,70.5) -- (372,80.5) ;
			      %Straight Lines [id:da8724970568833037] 
			      \draw    (362,40.5) -- (362,70.5) ;
			      %Straight Lines [id:da2364547366525216] 
			      \draw    (352,80.5) -- (362,70.5) ;
			      %Straight Lines [id:da6272356823343355] 
			      \draw    (362,50.5) -- (372,60.5) ;
			      %Straight Lines [id:da6570725683985683] 
			      \draw    (352,60.5) -- (362,50.5) ;


			      %Shape: Rectangle [id:dp9626444764701443] 
			      \draw   (250,20.5) -- (300,20.5) -- (300,150.5) -- (250,150.5) -- cycle ;
			      %Shape: Circle [id:dp6090522955421904] 
			      \draw   (260,45.5) .. controls (260,37.22) and (266.72,30.5) .. (275,30.5) .. controls (283.28,30.5) and (290,37.22) .. (290,45.5) .. controls (290,53.78) and (283.28,60.5) .. (275,60.5) .. controls (266.72,60.5) and (260,53.78) .. (260,45.5) -- cycle ;
			      %Shape: Circle [id:dp027965237702201273] 
			      \draw   (260,85.5) .. controls (260,77.22) and (266.72,70.5) .. (275,70.5) .. controls (283.28,70.5) and (290,77.22) .. (290,85.5) .. controls (290,93.78) and (283.28,100.5) .. (275,100.5) .. controls (266.72,100.5) and (260,93.78) .. (260,85.5) -- cycle ;
			      %Shape: Circle [id:dp861316711055095] 
			      \draw   (260,125.5) .. controls (260,117.22) and (266.72,110.5) .. (275,110.5) .. controls (283.28,110.5) and (290,117.22) .. (290,125.5) .. controls (290,133.78) and (283.28,140.5) .. (275,140.5) .. controls (266.72,140.5) and (260,133.78) .. (260,125.5) -- cycle ;

			      %Straight Lines [id:da11907679595228915] 
			      \draw    (210,90) -- (260,45.5) ;
			      %Straight Lines [id:da5387235665573882] 
			      \draw    (210,90) -- (260,85.5) ;
			      %Straight Lines [id:da9844971842464219] 
			      \draw    (210,90) -- (260,125.5) ;
			      %Straight Lines [id:da08618169043907886] 
			      \draw    (290,45.5) -- (340,60) ;
			      %Straight Lines [id:da23585015157398304] 
			      \draw    (290,85.5) -- (340,60) ;
			      %Straight Lines [id:da5208553684616741] 
			      \draw    (290,125.5) -- (340,125) ;

			      % Text Node
			      \draw (161,122) node [anchor=north west][inner sep=0.75pt]   [align=left] {Cliente};
			      % Text Node
			      \draw (247,161) node [anchor=north west][inner sep=0.75pt]   [align=left] {Sistema};
			      % Text Node
			      \draw (329,2) node [anchor=north west][inner sep=0.75pt]   [align=left] {Vendedor\\};
			      % Text Node
			      \draw (325,151) node [anchor=north west][inner sep=0.75pt]   [align=left] {Supervisor};
...
\begin{itemize}
	\item Niveles:
	      ...
	      \begin{itemize}
		      \item Requisitos del usuario: Son aquellos que nos los dicen los
		            usuarios.
		      \item Requisitos del Software: Son las descripciones formales de los
		      ...
		      \item Diferencias:
		            ...
		            \end{table}
	      \end{itemize}
	\item Clasificación de requisitos:
...
\begin{itemize}
	\item Completitud, organización por tipos de requisitos. Matriz de
	      trazabilidad.
	\item Consistencia, matriz de referencias cruzadas.
	\item Corrección, tamaño adecuado, claridad, capacidad de comprobación y
...
\begin{itemize}
	\item Nombre de asociación y Dirección del nombre.
	      \begin{figure}[H]
		      ...
		      {\def\svgwidth{.8\textwidth}
			      \input{./img/nombreDirAso.eps_tex}}
	      \end{figure}
	\item Nombres de rol
	      \begin{figure}[H]
		      \ffigbox[\FBwidth]
	...
	\item Restricciones en asociaciones
	      \begin{figure}[H]
		      ...
		      {\def\svgwidth{.75\textwidth}
			      \input{./img/restriccionesAso.eps_tex}}
	      \end{figure}
	      ...
	      \begin{itemize}
		      ...
		      \item Las multiplicidades originales se cruzan.
		            \begin{figure}[H]
			            ...
			            {\def\svgwidth{.8\textwidth}
				            \input{./img/multClaseAso.eps_tex}}
		            \end{figure}
	      \end{itemize}
\end{itemize}
\pagebreak
	      ...
	      \begin{itemize}
		      ...
		      \item Los componentes se refieren a:
		            \begin{itemize}
			            ...
			            \item Conjunto de datos usados en la implementación: ficheros, bases
			                  de datos, etc.
		            \end{itemize}
		      \item La arquitectura de desarrollo se representa a través de los
		            diagramas de componentes.
		      \item Componentes vs. Clases
		            \begin{itemize}
			            \item Se parecen a las clases en que tienen nombres, realizan
			                  interfaces, pueden participar en relaciones
			            \item Pero se diferencian en que las clases son abstracciones
			                  lógicas (se instancian como objetos) y los componentes son
			                  fragmentos físicos.
		            \end{itemize}
		      \item Componentes e interfaces
		            \begin{itemize}
			            \item Definen su comportamiento en base a interfaces requeridas y
			                  ofertadas.
			            \item Unos componentes implementan las interfaces y otros acceden a
			                  los servicios proporcionados por esas interfaces.
		            \end{itemize}
		      \item Estas relaciones se pueden mostrar con dos tipos de notación:
		            icónica o expandida.
	      \end{itemize}
	\item Vista de proceso (ejecución). No lo veremos.
	\item Vista física (despliegue). No lo veremos.
	\item Vista de casos de uso. La hemos visto, es del modelado conceptual.
\end{itemize}
...
\begin{itemize}
	...
	\item Ejemplo
	      \begin{figure}[H]
		      ...
		      {\def\svgwidth{.8\textwidth}
			      \input{./img/descomposicionModular.eps_tex}}
	      \end{figure}
...
\begin{figure}[H]
	\ffigbox[\FBwidth]
	{\caption{Elementos diagrama de componentes}}
	{
	...
	\begin{tikzpicture}[x=1.2pt,y=1.2pt,yscale=-1,xscale=1]
		...
		%Shape: Circle [id:dp3725419265934442] 
		\draw   (130,40) .. controls (130,34.48) and (134.48,30) .. (140,30) .. controls (145.52,30) and (150,34.48) .. (150,40) .. controls (150,45.52) and (145.52,50) .. (140,50) .. controls (134.48,50) and (130,45.52) .. (130,40) -- cycle ;
		%Straight Lines [id:da8978229923065655] 
		\draw    (130,40) -- (120,40) ;

		%Straight Lines [id:da2192481390393184] 
		\draw    (130,75) -- (120,75) ;
		%Shape: Arc [id:dp6670863781903611] 
		\draw  [draw opacity=0] (150.13,89.1) .. controls (148.53,89.68) and (146.8,90) .. (145,90) .. controls (136.72,90) and (130,83.28) .. (130,75) .. controls (130,66.72) and (136.72,60) .. (145,60) .. controls (146.8,60) and (148.53,60.32) .. (150.13,60.9) -- (145,75) -- cycle ; \draw   (150.13,89.1) .. controls (148.53,89.68) and (146.8,90) .. (145,90) .. controls (136.72,90) and (130,83.28) .. (130,75) .. controls (130,66.72) and (136.72,60) .. (145,60) .. controls (146.8,60) and (148.53,60.32) .. (150.13,60.9) ;

		%Straight Lines [id:da5403055776231709] 
		\draw    (165,115) -- (155,115) ;
		%Straight Lines [id:da5275288696095102] 
		\draw    (130,115) -- (120,115) ;
		%Shape: Arc [id:dp5500293381408676] 
		\draw  [draw opacity=0] (150.13,129.1) .. controls (148.53,129.68) and (146.8,130) .. (145,130) .. controls (136.72,130) and (130,123.28) .. (130,115) .. controls (130,106.72) and (136.72,100) .. (145,100) .. controls (146.8,100) and (148.53,100.32) .. (150.13,100.9) -- (145,115) -- cycle ; \draw   (150.13,129.1) .. controls (148.53,129.68) and (146.8,130) .. (145,130) .. controls (136.72,130) and (130,123.28) .. (130,115) .. controls (130,106.72) and (136.72,100) .. (145,100) .. controls (146.8,100) and (148.53,100.32) .. (150.13,100.9) ;
		%Shape: Circle [id:dp08960284162216103] 
		\draw   (135,115) .. controls (135,109.48) and (139.48,105) .. (145,105) .. controls (150.52,105) and (155,109.48) .. (155,115) .. controls (155,120.52) and (150.52,125) .. (145,125) .. controls (139.48,125) and (135,120.52) .. (135,115) -- cycle ;

		%Shape: Rectangle [id:dp7221203568073384] 
		\draw   (180,29.75) -- (240,29.75) -- (240,59.75) -- (180,59.75) -- cycle ;
		%Rounded Rect [id:dp6892406426037501] 
		\draw   (180,22) .. controls (180,20.9) and (180.9,20) .. (182,20) -- (218,20) .. controls (219.1,20) and (220,20.9) .. (220,22) -- (220,28) .. controls (220,29.1) and (219.1,30) .. (218,30) -- (182,30) .. controls (180.9,30) and (180,29.1) .. (180,28) -- cycle ;
		%Rounded Rect [id:dp29493615027973497] 
		\draw   (180,80) .. controls (180,74.48) and (184.48,70) .. (190,70) -- (240,70) .. controls (245.52,70) and (250,74.48) .. (250,80) -- (250,110) .. controls (250,115.52) and (245.52,120) .. (240,120) -- (190,120) .. controls (184.48,120) and (180,115.52) .. (180,110) -- cycle ;
		%Rounded Rect [id:dp7036701289896021] 
		\draw   (170,82) .. controls (170,80.9) and (170.9,80) .. (172,80) -- (188,80) .. controls (189.1,80) and (190,80.9) .. (190,82) -- (190,88) .. controls (190,89.1) and (189.1,90) .. (188,90) -- (172,90) .. controls (170.9,90) and (170,89.1) .. (170,88) -- cycle ;
		%Rounded Rect [id:dp9275367347584413] 
		\draw   (170,102) .. controls (170,100.9) and (170.9,100) .. (172,100) -- (188,100) .. controls (189.1,100) and (190,100.9) .. (190,102) -- (190,108) .. controls (190,109.1) and (189.1,110) .. (188,110) -- (172,110) .. controls (170.9,110) and (170,109.1) .. (170,108) -- cycle ;

		%Straight Lines [id:da9385203120738059] 
		\draw    (120,143) -- (170,143) ;
		%Straight Lines [id:da5697016687462559] 
		\draw  [dash pattern={on 4.5pt off 4.5pt}]  (200,162) -- (250,162) ;

		% Text Node
		\draw (60,64) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small I. requerida}};
		% Text Node
		\draw (67,29) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small I. ofrecida}};
		% Text Node
		\draw (187,85) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small Componente}};
		% Text Node
		\draw (72,105) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small Interfaz}};
		% Text Node
		\draw (71,132) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small Relación}};
		% Text Node
		\draw (71,152) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small Relación de dependencia}};
		% Text Node
		\draw (189.5,36.25) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\small Paquete}};
